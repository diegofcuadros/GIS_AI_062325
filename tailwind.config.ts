  ...
  theme: {
    extend: {
      colors: {
        ...
        gis: {
          primary: "hsl(var(--gis-primary))",
          secondary: "hsl(var(--gis-secondary))",
          accent: "hsl(var(--gis-accent))",
        },
        health: {
      ...
      fontSize: {
        ...
        'display-xl': ['3.75rem', { lineHeight: '4rem', fontWeight: '600' }],
        'display-2xl': ['4.5rem', { lineHeight: '4.5rem', fontWeight: '700' }],
      },
      spacing: {
        '18': '4.5rem',
        '88': '22rem',
      ...
      boxShadow: {
        ...
        'interactive': '0 4px 12px 0 rgb(0 0 0 / 0.15)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
